...
ap.add_argument("--n-root", type=int, default=24, help="fixed shared root candidate pool")
ap.add_argument("--budgets", default="1000,4000,16000,64000")
ap.add_argument("--seeds", default="a,b")
# finite reference fidelity
ap.add_argument("--k1", type=int, default=12, help="root execution draws (CRN)")
ap.add_argument("--n-opp1", type=int, default=10, help="opponent reply pool at h=3")
ap.add_argument("--k2", type=int, default=3, help="opponent execution draws (CRN)")
ap.add_argument("--h2-cand", type=int, default=10)
ap.add_argument("--h2-k3", type=int, default=6)
ap.add_argument("--h2-opp", type=int, default=8)
ap.add_argument("--h2-k4", type=int, default=4)
